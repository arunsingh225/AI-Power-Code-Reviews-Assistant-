...
function generateMarkdown(data, meta) {
  ...
  md += `*Generated by [CodeSentinel](https://github.com) — AI Code Review Agent powered by Claude*\n`
  return md
}
...
function LoadingScreen() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[480px] gap-10">
      ...
      <p className="font-mono text-xs text-slate-600">Powered by Claude Sonnet 4</p>
    </div>
  )
}
...
function ResultsDashboard({ data, meta, onReset, onExport }) {
        ...
        {["critical","high","medium","low","info"].map(sev => {
          ...
          return (
            <button
              ...
              className="card p-3 text-center transition-all duration-200 hover:bg-bg-hover"
        ...
        <div className="card p-4">
          ...
          <div className="space-y-2">
            {prInfo.files.map((f, i) => (
              <div key={i} className="flex items-center justify-between text-sm py-1.5 border-b border-bg-border last:border-0">
                <span className="font-mono text-xs text-slate-400 truncate flex-1 mr-3">{f.name}</span>
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      if (inputMode === "github") {
        ...
        meta = { label: prUrl.trim(), type: "github" }
      } else {
    ...
    <div className="min-h-screen bg-grid">
      ...
      <footer className="border-t border-bg-border py-6">
        <div className="max-w-6xl mx-auto px-6 flex items-center justify-between flex-wrap gap-3">
          ...
          <span className="font-mono text-xs text-slate-700">Claude Sonnet 4 · FastAPI · React</span>
        </div>
      </footer>
